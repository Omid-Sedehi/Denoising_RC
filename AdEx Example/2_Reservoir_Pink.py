...
if __name__ == "__main__":
    ...
    torch.save(rc, './Models/Model_Tuned_10p_Pink.pth')
...
####### Perform Pruning ###########################################################################################
    ...
    # Save the entire model
    torch.save(rc, './Models/Model_Pruned_10p_Pink.pth')
    ...
    axs[0].text(0.02, 0.95, 'g)', transform=axs[0].transAxes, fontsize=12, verticalalignment='top')
    ...
    axs[1].text(0.02, 0.95, 'h)', transform=axs[1].transAxes, fontsize=12, verticalalignment='top')
    ...
    axs[2].text(0.02, 0.95, 'i)', transform=axs[2].transAxes, fontsize=12, verticalalignment='top')
    ...
    ax_inset.psd(1000 *(x_true[100:, 0] - X_Total[100:, 0]), NFFT=NFFT, noverlap=NFFT // 2, Fs=100000, color='seagreen')
    ax_inset.psd(1000 *(x_true[100:, 0] - y_pred_tuned[100:, 0]), NFFT=NFFT, noverlap=NFFT // 2, Fs=100000, color='firebrick')
    ...
    axs.text(0.02, 0.95, 'c)', transform=axs.transAxes, fontsize=12, verticalalignment='top')
