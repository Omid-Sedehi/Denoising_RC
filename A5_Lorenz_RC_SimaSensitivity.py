...
for ii in range(0,col_size0):
    for pp in range(0,col_size):
        ...
        for qq in range(0,row_size):
            model = torch.load('./Models/Model_Tuned_25p' + Error_char[qq] + '.pth', weights_only=False)
...
plt.legend()
# plt.title(r'RC Trained on 25% RMS Error Noise and $\sigma = 8 and 10$')
# plt.title(r"RC Trained on $\sigma = 10 $ and SNR = 4")
